...
const ExperienceTimeline = () => {
    ...
    return (
        ...
        // "4px solid red"
        >
            <Heading mb={"10"} as="h1" data-aos="fade-down" color={useColorModeValue("gray.600","white")} textAlign="center" display={{ base: "block", lg: "none" }}>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text fontWeight="semibold" color={useColorModeValue("gray.500","white")} mb={1} fontSize={{ base: "sm", md: "md" }}>
                    {position}
                </Text>
                <Text color={useColorModeValue("gray.500","white")} fontSize={{ base: "xs", md: "sm" }} mb={3}>
                    {duration}
                </Text>
                <Text color={useColorModeValue("gray.500","gray.300")} fontSize={{ base: "sm", md: "md" }}>
                    {description}
                </Text>
            </Box>
        </Box>
